...
class GetWeatherInfo : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.weather_after_ringing, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mFusedLocationClient.lastLocation.addOnSuccessListener {
            if(it != null) {
                ...
                val strLocate = view.findViewById<TextView>(R.id.location)
    ...
    private inner class GetXMLTask() : AsyncTask<String, Void, Document>() {
        ...
        var updateT = view!!.findViewById<TextView>(R.id.updateTime)
    ...
    private fun convertGRID_GPS(lat_X: Double, lng_Y: Double): LatXLngY {
        ...
        Log.d("rs.lat, rs.lng", "${rs.lat} , ${rs.lng}")
        Log.d("rs.x, rs.y", "${rs.x} , ${rs.y}")
        return rs
    }
